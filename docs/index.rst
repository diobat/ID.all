...
On the RPI's root directory there is shell executable file configured to run on startup (startup.sh), this file can be edited. to make the RPI automatically start demodulating upon poweron without any necessary user input.
